...
type Props = {
  material: number;
  setMaterial: ChangeEventHandler<HTMLInputElement>;
  activeMaterial: number;
};

const MaterialItem = ({ material, setMaterial, activeMaterial }: Props) => {
  const [data, setData] = useState<TMaterial | null>(null);
