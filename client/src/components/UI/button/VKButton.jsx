...
const VKButton = () => {
  ...
  return (
    <button
      onClick={onClick}
      className={
        "flex py-2 px-4 bg-[#07F] text-white rounded-xl items-center max-w-l mx-auto gap-4 font-medium justify-center"
      }>
      <svg className='w-10 h-auto' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 192 192'>
        <g fill='none' fillRule='evenodd' id='g6'>
          <path
            fill='#fff'
