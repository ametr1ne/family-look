...
const UpdateProduct = ({ currentData, opened, setOpened, categories, collections }: Props) => {
  const [name, setName] = useState(currentData.name);
  const [categoryId, setCategoryId] = useState(currentData.category);
  const [price, setPrice] = useState(currentData.price);
  const [collectionId, setCollectionId] = useState(currentData.collection);
